...
<body>
    ...
    <div id="formContent">
        ...
        <div class="menu-grid" id="departmentMenu">
            ...
            <a class="menu-item" href="menusformularios/menuSubdirecciónProgramasPrevenciónDelito.php">JUD de Seguridad Ciudadana y de Tránsito</a>
            <a class="menu-item" href="menusformularios/menuSubdirecciónProgramasPrevenciónDelito.php">JUD de Control Operativo PoliciaL</a>
            <a class="menu-item" href="menusformularios/menuSubdirecciónProgramasPrevenciónDelito.php">JUD de Panteones</a>
            <a class="menu-item" href="menusformularios/menuSubdirecciónProgramasPrevenciónDelito.php">JUD de Tianguis y Vía Pública</a>
            <a class="menu-item" href="menusformularios/menuSubdirecciónProgramasPrevenciónDelito.php">JUD de Mercados y Concentraciones </a>
            <?php 
            $href_static = [
